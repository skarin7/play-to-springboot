...
# Usage: ./setup.sh <path-to-play-repo> [--workspace <dir>] [--spring-name <name>]
#
# Example: ./setup.sh /path/to/your-play-repo
#   -> Creates spring-<basename>/ (sibling), workspace.yaml, <play-repo>/.cursor/{config,docs,skills} (Cursor-native layout).
#
# Example: ./setup.sh /path/to/your-play-repo --workspace /tmp/migrate --spring-name my-spring-app
...
# Generated by play-to-spring-kit setup.sh
play_repo: $PLAY_REPO
