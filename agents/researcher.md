...
Toolchain health is not your concern — the manager fetches and checksum-verifies
the dev-toolkit JAR before dispatching you, and will not have got this far with a
bad one. Spend your effort on the code.
